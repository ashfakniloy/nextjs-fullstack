    ...
    <div ref={node} className="flex items-center gap-3 text-sm relative">
      ...
      {likes?.length ? (
        <div>
          ...
          {showLikes && (
            <div className="bg-gray-800 absolute left-0 top-[30px] w-full rounded min-w-[170px] border border-gray-700 overflow-hidden z-10">
              ...
              <div className="border-t border-gray-700 overflow-hidden max-h-[240px] overflow-y-auto scrollbar-thin scrollbar-track-gray-600/50 scrollbar-thumb-gray-500/50 ">
                {likes?.map((like, i) => (
                  <Link
                    key={i}
                  ...
                  >
                    <p
                      className={`w-full text-left p-3 text-xs hover:bg-gray-700 ${
